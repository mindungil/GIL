...
// (testInterviewServer methods deleted in M3 — InterviewService is gone.)
...
// (TestClient_StartInterview_StreamsEvents / TestClient_ConfirmInterview /
// TestClient_GetSpec deleted in M3 — InterviewService is gone. The chat
// path uses Client.Prompt; spec inspection lives in the agent's
// show_spec tool now.)
